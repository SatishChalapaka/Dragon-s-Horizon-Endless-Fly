...
namespace MalbersAnimations.InputSystem
{
    ...
    public class MInputPlayerManager : MonoBehaviour
    {
        ...
        [SerializeField] private List<PlayerNotifications> playerOutputChannels;
        ...
        private void Reset()
        {
            playerOutputChannels = new List<PlayerNotifications>
            {
                PlayerNotifications.InvokeCSharpEvents,
                PlayerNotifications.BroadcastMessages,
                PlayerNotifications.SendMessages,
