...
public class IAPCoins : MonoBehaviour, IStoreListener
{
    ...
    public static string firstPack = "1000coins";
    ...
    public static string purchaseAllMouseDragons = "purchaseallbabydragons";//PURCHASE ALL BABY DRAGONS
    public static string purchaseAllTigerDragons = "purchaseallearthdragons";//PURCHASE ALL EARTH DRAGONS
    public static string purchaseAllSeaDragons = "purchaseallwaterdragons";//PURCHASE ALL WATER DRAGONS
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(purchaseAllMouseDragons, ProductType.NonConsumable);
        builder.AddProduct(purchaseAllTigerDragons, ProductType.NonConsumable);
        builder.AddProduct(purchaseAllSeaDragons, ProductType.NonConsumable);
        builder.AddProduct(purchaseAll, ProductType.NonConsumable);
